            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <form method="post"  action="{{ route('sons.attendance.search') }}" autocomplete="off">
                        ...
                        <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" type="submit">{{trans('بحث')}}</button>
                    </form>
                    @isset($Students)
                        <div class="table-responsive">
                            <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
                                ...
                                <tr>
                                    ...
                                    <th class="alert-success">{{trans('اسم الطالب')}}</th>
                                    <th class="alert-success">{{trans('المرحلة')}}</th>
