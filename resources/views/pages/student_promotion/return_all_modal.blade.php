<div class="modal fade" id="returnAllModal" tabindex="-1">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">{{trans('student_promotion.Back_All')}}</h4>
            ...
            <form method="post" action="{{route('StudentPromotion.destroy','test')}}">
                ...
                <div class="modal-body">
                    <h5 style="color: red">{{trans('student_promotion.Return_All_Message')}}</h5>
                    <input type="hidden" id="id" name="page_id" value="1">
                </div>
