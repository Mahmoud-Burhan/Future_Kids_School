                            ...
                            <table id="datatable" class="table table-hover table-sm table-bordered p-0">
                                ...
                                @foreach($questions as $question)
                                    <tr style="text-align: center">
                                        ...
                                        <td>
                                            <a href="{{route('teacherQuestion.edit',$question->id)}}" class="btn btn-outline-primary btn-sm">
                                    ...
                                    @include('pages.teachers.dashboard.questions.deleteModal')
                                @endforeach
                                </tbody>
                            </table>
                        </div>

                        <a href="{{route('teacherQuestion.show',$quiz_id)}}" class="btn btn-success">
