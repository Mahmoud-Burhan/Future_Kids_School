                    ...
                    <div class="table-responsive">
                        <table id="datatable" class="table table-hover table-sm table-bordered p-0"
                            ...
                            @foreach($online_classes as $online_class)
                                ...
                                @include("pages.teachers.dashboard.online_classes.DeleteModal")
                            @endforeach
                            </tbody>
                        </table>
                    </div>
                    <a href="{{route('TeacherOnlineClasses.create')}}" class="btn btn-success">
                        <i class="fa fa-plus"></i>
                        {{trans('online_classes.Add_New_Class')}}
                    </a>
                    &nbsp;
                    <a href="{{route('teacherIndirect.create')}}" class="btn btn-primary">
                        <i class="fa fa-plus"></i>
