 ...
 Main content -->
    ...
    <div class="content-wrapper">
        <div class="page-title">
            <div class="row">
                <div class="col-sm-6">
                    <h4 class="mb-0"> {{trans('teacher_dashboard.Welcome')}} {{auth()->user()->name}}</h4>
                </div>
                <div class="col-sm-6">
                        ...
                        <div class="clearfix">
                            <div class="float-left">
                                    <span class="text-success">
                                       <i class="fas fa-door-open highlight-icon" aria-hidden="true"></i>
                                    </span>
                            </div>
                            <div class="float-right text-right">
                                <p class="card-text text-dark" style="font-weight: bolder;font-size: 16px;">
                                    {{trans('teacher_dashboard.total_sections')}}
                                </p>
                                <h4>{{$section_ids->count()}}</h4>
                            </div>
                        </div>
                        <p class="text-muted pt-3 mb-0 mt-2 border-top">
