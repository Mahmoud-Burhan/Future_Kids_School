 ...
 header start-->
        <nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            ...
            <div class="text-left navbar-brand-wrapper">
                <a class="navbar-brand brand-logo" href="index.html">   <img src="{{URL::asset('Attachments/Settings_Logo/Future_kids_logo/Future_kids_logo.jpeg')}}" alt="avatar"
                   style="width: 80px;height: 70px;" ></a>
                <a class="navbar-brand brand-logo-mini" href="index.html">   <img src="{{URL::asset('Attachments/Settings_Logo/Future_kids_logo/Future_kids_logo.jpeg')}}" alt="avatar"></a>
            </div>
            <!-- Top bar left -->
            ...
            <ul class="nav navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown mr-30">
                    <a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button"
                        ...
                        <img src="{{URL::asset('Attachments/Settings_Logo/Future_kids_logo/Future_kids_logo.jpeg')}}" alt="avatar">
                    </a>
                                            ...
                                            <form method="GET" action="{{ route('logout','family') }}">
                                                @else
                                                    <form method="GET" action="{{ route('logout','web') }}">
                                                        ...
                                                        @csrf
                                                        <a class="dropdown-item" href="#" onclick="event.preventDefault();this.closest('form').submit();"><i class="bx bx-log-out"></i>{{trans('multi_auth.Logout')}}</a>
                                                    </form>
                    </div>
                </li>
            </ul>
